...
# Load tokenizer and GPT-2 Small model
model_name = "gpt2"  # This is GPT-2 Small (124M parameters)
tokenizer = AutoTokenizer.from_pretrained(model_name)

# GPT-2 uses <|endoftext|> as both eos and pad token
...
print("Evaluating GPT-2 Small on SST-2 Classification Task (Prompt-Based Generation)...")
print("="*60)
...
Sentiment:"""
        ...
        if "positive" in generated_text:
            ...
            if first_word.startswith("pos"):
                ...
                # Random guess if completely unclear (default to negative)
                prediction = 0
...
# Print results
print("\n" + "="*60)
print("GPT-2 SMALL CLASSIFICATION RESULTS ON SST-2 (PROMPT-BASED)")
print("="*60)
