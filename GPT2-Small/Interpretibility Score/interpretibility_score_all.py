...
Original file is located at
    https://colab.research.google.com/#fileId=https%3A//storage.googleapis.com/kaggle-colab-exported-notebooks/kylian007/interpretibility-score.4aff3a5a-edbf-4dc1-a409-3ad68dbe2040.ipynb%3FX-Goog-Algorithm%3DGOOG4-RSA-SHA256%26X-Goog-Credential%3Dgcp-kaggle-com%2540kaggle-161607.iam.gserviceaccount.com/20251010/auto/storage/goog4_request%26X-Goog-Date%3D20251010T180429Z%26X-Goog-Expires%3D259200%26X-Goog-SignedHeaders%3Dhost%26X-Goog-Signature%
"""
...
def interpretability_score_pipeline(sparse_autoencoder, validation_tokenized, validation_sentences, feature_index, device):
    ...
    filename="interpretability_report.txt",
...
# Features unique to positive sentences (not in negative)
...
# Features unique to negative sentences (not in positive)
...
if __name__ == "__main__":
    ...
    # Load HookedSAETransformer and SAE
    model = HookedSAETransformer.from_pretrained("gpt2-small", device=device)
    sae_cfg = StandardTrainingSAEConfig(
        d_in=768,
        d_sae=1536,
    ...
    report_filename = "all_features_interpretability_report.txt"
    with open(report_filename, "w", encoding="utf-8") as f:
        f.write("INTERPRETABILITY ANALYSIS REPORT FOR UNCOMMON FEATURES\n")
        f.write("="*70 + "\n\n")
